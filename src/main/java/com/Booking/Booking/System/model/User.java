...
public class User {
    ...
    // ─── Valid Roles ──────────────────────────────────────────────────────────────
    // Only two roles exist for now: MEMBER (default) and ADMIN
    ...
    // Role: "MEMBER" or "ADMIN" — defaults to MEMBER for all public registrations
    @Column(nullable = false)
    ...
    public void setRole(String role) {
        // Never allow null/empty — default to MEMBER
        this.role = (role != null && !role.isBlank()) ? role : ROLE_MEMBER;
    }
}
